...
angular.module('WebSRF').directive('fieldDirective', function($http, $compile,shareDataService) {
    ...
    return {
        ...
        controller: function($scope, $element, $http) {
        	...
        	/*$scope.type = {};
        	$scope.type.typename = "text";
        	if($scope.field.fieldName == "ContactEmail"){
        		$scope.type.typename = "email";
        	}*/
            ...
            $scope.selectProperty = function (element,item,index){
            	//console.log("checked " + element.fieldName);
            	//console.log("element " + JSON.stringify(item));
            	if(element.fieldName == "PropInterest"){
            		shareDataService.storePropInterest(item);
            	}
            	else if(element.fieldName == "ValuationPremise"){
            		shareDataService.storeValuationPremise(item);
            	}
            }
