    ...
    $scope.showJsonDiv = function(){
 	 ...
 	 for(var i = 0 ; i < $scope.form.collateral.length ; i ++){
		  ...
		  if($scope.collateralObject.fieldName == "BuildingSize"){
			...
			if($scope.collateralObject.fieldName == "ValuationPremise"){
				  delete $scope.collateralObject.fieldValue;
				  $scope.collateralObject.fieldValue = [];
				  $scope.collateralObject.fieldValue = shareDataService.getValuationPremise();
			}
			if($scope.collateralObject.fieldName == "PropInterest"){
				delete $scope.collateralObject.fieldValue;
				  $scope.collateralObject.fieldValue = [];
				  $scope.collateralObject.fieldValue = shareDataService.getPropInterest();
			}
